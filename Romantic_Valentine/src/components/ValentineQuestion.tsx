...
export function ValentineQuestion({ onNext }: ValentineQuestionProps) {
  ...
  return (
    ...
    >
      ...
      <div className="text-center max-w-4xl relative z-10 mx-auto">
        {/* Couple photos instead of teddy bears */}
        <motion.div
        ...
        >
          <motion.div
            ...
            className="relative w-20 h-20 md:w-32 md:h-32 rounded-full overflow-hidden border-4 border-white shadow-2xl"
          >
            <img 
              src={couplePhoto1}
              alt="Chérie and Theodore"
